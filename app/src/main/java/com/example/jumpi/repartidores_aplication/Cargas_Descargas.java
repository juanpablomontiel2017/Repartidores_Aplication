...
public class Cargas_Descargas extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* Guardaremos las "Nuevas Tandas" creadas en ArrayTandas, donde esas tandas se ubicarán en el Layout Vertical Padre */
 ...
 /***************************************************************************************************/
    ...
    public void EliminarCualquierTanda(final View v){
                ...
                builder.setMessage("Al presionar el botón 'Eliminar Tanda' se borrará la tanda fue seleccionada. ¿Desea continuar?");
