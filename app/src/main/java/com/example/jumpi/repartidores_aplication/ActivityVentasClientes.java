...
public class ActivityVentasClientes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ventas_clientes);
    ...
    public void RecibirParametrosDeLosClientesVentasSupervisores(){
        ...
        if(extras.equals("No tiene correo")){
            ...
            Correo_Cliente_Ventas.setTextColor(Color.parseColor("#616161"));
    ...
    public View AgregarNuevoArticuloParaVentasRepartidores(final LinearLayout LayoutVertical) {
        ...
        final View InflatedViewVentas = inflater.inflate(R.layout.item_nuevo_articulo_ventas, null, true);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(Utils_Spinner.contador_de_inicializacion < Utils_Spinner.contador_spinner){
                    ...
                    /*Llamada a la función: */
                    Utils_Spinner.RefrescarOtrosSpinnerConBordes((Spinner)adapterView,ArticuloSeleccionadoAnterior,text, ActivityVentasClientes.this);
