...
public class FragmentStockEnVehiculo extends Fragment {
    ...
    public FragmentStockEnVehiculo() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btn_detalle_envases.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(getActivity(), ActivityDetalleEnvases.class);
        ...
        btn_detalle_dinero.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(getActivity(), ActivityDetalleDinero.class);
                startActivity(intent);
        ...
        btn_detalle_articulos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(getActivity(), ActivityDetalleArticulos.class);
                startActivity(intent);
        ...
        btn_detalle_faltante_sobrante.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(getActivity(), ActivityDetalleFaltanteSobranteEnvases.class);
                startActivity(intent);
