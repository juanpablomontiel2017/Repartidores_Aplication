...
public class ActivityEntregaRetiroEnvasesPatrocinio extends AppCompatActivity {
    ...
    public void CargarVistasEventoHabilitado(){
        ...
        /*Llamada a la función:  */
        CargarReferenciasPrimerVuelta(toolbar);
    ...
    public void CargarVistasEventoDeshabilitado(){
        ...
        /*Llamada a la función:  */
        CargarReferenciasPrimerVueltaEventoCerrado();
    ...
    public void CambiarColoresEditarEventoFinalizado(){
        ...
        for(int k=0; k < ArrayListVueltas.size(); k++) {
            ...
            llv_borde.setBackground(getDrawable(R.drawable.contenedor_ll_uno));
            ...
            tv_vuelta.setBackgroundColor(Color.parseColor("#0091ea"));
    ...
    public void CambiarColoresEditarEventoFinalizadoRepartidor(){
        ...
        for(int k=0; k < ArrayListVueltas.size(); k++) {
            ...
            final LinearLayout llv_borde = (LinearLayout) ArrayListVueltas.get(k).findViewById(R.id.llv_contenedor_para_bordes_erep);
            llv_borde.setBackground(getDrawable(R.drawable.contenedor_ll_cuatro));
    ...
    public void CambioDeColoresAlGuardarNuevamenteEventoFinalizado(){
        ...
        for(int k=0; k < ArrayListVueltas.size(); k++) {
            ...
            final LinearLayout llv_borde = (LinearLayout) ArrayListVueltas.get(k).findViewById(R.id.llv_contenedor_para_bordes_erep);
            llv_borde.setBackground(getDrawable(R.drawable.contenedor_ll_siete_evento_deshabilitado));
    ...
    public void CargarReferenciasPrimerVuelta(Toolbar toolbar){
    ...
    public void CargarReferenciasPrimerVueltaEventoCerrado(){
        ...
        LinearLayoutVerticalBorde = (LinearLayout) findViewById(R.id.llv_contenedor_para_bordes_erep);
        LinearLayoutVerticalBorde.setBackground(getDrawable(R.drawable.contenedor_ll_siete_evento_deshabilitado));
    ...
    public void CierreDeEvento(int indice_evento) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(ActivityEntregaRetiroEnvasesPatrocinio.this);
                ...
                public void onClick(DialogInterface dialog, int id) {
                    ...
                    if (ArrayListVueltas.size() > 1) {
                        ...
                        if(ValorDeLaPosicion != 99){
                            ...
                            Toast.makeText(ActivityEntregaRetiroEnvasesPatrocinio.this, "La vuelta ha sido eliminada", Toast.LENGTH_LONG).show();
                            ...
                            Toast.makeText(ActivityEntregaRetiroEnvasesPatrocinio.this, "Posicion: " + ValorDeLaPosicion, Toast.LENGTH_LONG).show();
                        ...
                        Toast.makeText(ActivityEntregaRetiroEnvasesPatrocinio.this, "¡No es posible eliminar la primer vuelta. Por favor, tenga en cuenta crear una nueva vuelta!", Toast.LENGTH_LONG).show();
    ...
    public void ObtenerNuevoArticuloEntregaRetiroPorPatrocinio(String ValorElementoSeleccionadoSpinnerProgramatico,String Valor_a_SetearDelEditTextEntregaNuevoArticulo,
        ...
        /** Instanciamos las vistas del diseño XML: "item_nuevo_articulo.xml" **/
    ...
    public View AgregarNuevoArticuloEntregaRetiroPorPatrocinio(final LinearLayout LayoutVerticalTercerTuplaPatrocinio) {
        ...
        final View InflatedView = inflaterPatrocinio.inflate(R.layout.item_nuevo_articulo, null, true);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if(Utils_Spinner.contador_de_inicializacion < Utils_Spinner.contador_spinner){
                    ...
                    /*Llamada a la función: */
                    Utils_Spinner.RefrescarOtrosSpinner((Spinner)adapterView,ArticuloSeleccionadoAnterior,text, ActivityEntregaRetiroEnvasesPatrocinio.this);
    ...
    public void ObtenerNuevaVuelta(String ValorElementoSeleccionadoSpinnerFijo,String ValorSeteadoDelEditTextEntregaDeArticulosParaNuevaVuelta,
        ...
        /****Evento cerrado****/
            ...
            if(usuario.getTipo_de_Usuario().equals("repartidor")){
                ...
                final LinearLayout LinearLayoutVerticalProgramaticoConBorde = (LinearLayout) findViewById(R.id.llv_contenedor_para_bordes_erep);
                LinearLayoutVerticalProgramaticoConBorde.setBackground(getDrawable(R.drawable.contenedor_ll_siete_evento_deshabilitado));
    ...
    public View AgregarNuevaVuelta(){
        ...
        final View InflatedView = inflaterVuelta.inflate(R.layout.item_nueva_entrega_retiro_patrocinio, null, true);
            ...
            for(int k=0; k < ArrayListVueltas.size(); k++){
                ...
                if(text_spinner_fijo == "Envases rotos/pinchados" || text_spinner_fijo == "Dispenser plástico roto"
                   || text_spinner_fijo == "Dispenser eléctrico \n averiado"){
                    ...
                    editText_retiro_vuelta.setBackgroundDrawable(getDrawable(R.drawable.edit_text_underline_coloraccent));
                    ...
                    editText_entrega_vuelta.setBackgroundDrawable(getDrawable(R.drawable.edit_text_underline_coloraccent));
                ...
                for(int l = 1 ; l < LLV_Tercer_Tupla_Patrocinio.getChildCount() ; l++){
                    ...
                    if(text_spinner_programatico == "Envases rotos/pinchados" ||
                        ...
                        et_retiro_del_nuevo_articulo.setBackgroundDrawable(getDrawable(R.drawable.edit_text_underline_coloraccent));
                        ...
                        et_entrega_del_nuevo_articulo.setBackgroundDrawable(getDrawable(R.drawable.edit_text_underline_coloraccent));
    ...
    public boolean onOptionsItemSelected (final MenuItem item){
        ...
        if (id == R.id.action_save_vuelta) {
            ...
            Usuario usuario = new Usuario();
            usuario.LeerUsuarioEnUnSharedPreferences(ActivityEntregaRetiroEnvasesPatrocinio.this);
        ...
        if(id == R.id.action_finish_evento){
            ...
            if (ArrayListVueltas.size() == DimensionArrayNuevasVueltas) {
                ...
                if(DeshabilitarVistasDeLasVueltasAlGuardarCambios(ValidarTodosLosCamposParaGuardarCambiosEnCadaVuelta())){
                    ...
                    Intent intent = new Intent(ActivityEntregaRetiroEnvasesPatrocinio.this, ActivityBuscarResponsablePatrocinio.class);
        ...
        if(id == R.id.action_avaible_evento){
            ...
            TV_Titulo_Evento.setTextColor(Color.parseColor("#0091ea"));
