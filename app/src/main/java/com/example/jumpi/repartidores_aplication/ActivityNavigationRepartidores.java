...
public class ActivityNavigationRepartidores extends AppCompatActivity implements OnNavigationReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (ActivityProvenienteDe) {
            ...
            case "Mapa_Repartidores":
                ...
                Toast.makeText(ActivityNavigationRepartidores.this, "¡Bienvenido!", Toast.LENGTH_LONG).show();
            ...
            default:
                ...
                Toast.makeText(ActivityNavigationRepartidores.this, "¡No se encontró la activity!", Toast.LENGTH_LONG).show();
    ...
    private void showDropoffDialog() {
        ...
        alertDialog.setButton(DialogInterface.BUTTON_NEGATIVE, "Cancelar Temporalmente",
                (dialogInterface, in) -> {
                    ...
                    Intent intent = new Intent(ActivityNavigationRepartidores.this, ActivityMapaRepartidores.class);
    ...
    public void MostrarMensajeDeVenta(){
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(ActivityNavigationRepartidores.this);
        ...
        builder.setPositiveButton("Realizar Venta", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int id) {
                ...
                Intent intentVentas = new Intent(ActivityNavigationRepartidores.this, ActivityVentasClientes.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == MAPA_REPARTIDORES_ON_KEY) {
            ...
            if (resultCode == RESULT_OK) { // Activity.RESULT_OK
                ...
                //En caso de que el resultado fuera correcto
                Toast.makeText(ActivityNavigationRepartidores.this, "¡Haz quedado aquí!", Toast.LENGTH_LONG).show();
