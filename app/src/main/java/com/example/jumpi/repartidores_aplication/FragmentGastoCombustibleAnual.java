 ...
 * Use the {@link FragmentGastoCombustibleAnual#newInstance} factory method to
...
public class FragmentGastoCombustibleAnual extends Fragment {
    ...
    public FragmentGastoCombustibleAnual() {
    ...
    public static FragmentGastoCombustibleAnual newInstance(String param1, String param2) {

        FragmentGastoCombustibleAnual fragment = new FragmentGastoCombustibleAnual();
