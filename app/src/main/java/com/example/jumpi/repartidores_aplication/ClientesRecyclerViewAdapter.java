            ...
            public void onClick(View view) {
                ...
                dialog_cliente_btnVentas.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent intentVentas = new Intent(parent.getContext(), ActivityVentasClientes.class);
                ...
                dialog_cliente_btnEditar.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        Intent intentEditar = new Intent(parent.getContext(), ActivityEditarClientes.class);
