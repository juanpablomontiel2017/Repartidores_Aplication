 ...
 * Use the {@link FragmentGastoCombustiblePorMes#newInstance} factory method to
...
public class FragmentGastoCombustiblePorMes extends Fragment {
    ...
    public FragmentGastoCombustiblePorMes() {
    ...
    public static FragmentGastoCombustiblePorMes newInstance(String param1, String param2) {


        FragmentGastoCombustiblePorMes fragment = new FragmentGastoCombustiblePorMes();
