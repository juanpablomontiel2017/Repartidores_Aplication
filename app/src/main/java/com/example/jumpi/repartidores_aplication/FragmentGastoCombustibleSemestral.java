 ...
 * Use the {@link FragmentGastoCombustibleSemestral#newInstance} factory method to
...
public class FragmentGastoCombustibleSemestral extends Fragment {
    ...
    public FragmentGastoCombustibleSemestral() {
    ...
    public static FragmentGastoCombustibleSemestral newInstance(String param1, String param2) {


        FragmentGastoCombustibleSemestral fragment = new FragmentGastoCombustibleSemestral();
