...
public class DbHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE = "create table "+DbContract.TABLE_NAME+"("+DbContract.DNI+" integer primary key,"+DbContract.ID+" integer,"+DbContract.USUARIO+" text,"+DbContract.PASSWORD+" text, "+DbContract.SYNC_STATUS+" integer);";
