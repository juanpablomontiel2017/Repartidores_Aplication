...
public class DbHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE = "create table "+DbContract.TABLE_NAME_USUARIO+"("+DbContract.DNI+" integer primary key,"+DbContract.ID+" integer,"+DbContract.USUARIO+" text,"+DbContract.PASSWORD+" text,"+DbContract.TIPO_USUARIO+" text, "+DbContract.SYNC_STATUS+" integer);";
    ...
    public  void guardarUsuario(int dni, int id, String usuario, String password, String tipoUsuario, int sync_status, SQLiteDatabase database){
        ...
        contentValues.put(DbContract.TIPO_USUARIO, tipoUsuario);
    ...
    public Cursor readFromLocalDatabase (SQLiteDatabase database){
        String[] projection = {DbContract.DNI, DbContract.ID, DbContract.USUARIO, DbContract.PASSWORD,  DbContract.TIPO_USUARIO, DbContract.SYNC_STATUS};
    ...
    public void updateLocalDatabase(int dni, int id, String usuario, String password, String tipoUsuario, int sync_status, SQLiteDatabase database){
